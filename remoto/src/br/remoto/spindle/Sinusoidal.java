...
public class Sinusoidal extends Input{
	...
	public Sinusoidal(String str_initial_time,String str_time_step,String str_final_time,
						String str_start_time,String str_end_time_sin,
		...
		end_time = Double.parseDouble(str_end_time_sin);
