...
public class RampAndHold extends Input{

	protected double initial_value;
	protected double final_value;
	//protected Random gaussianNoise = new Random();
	
	public RampAndHold(String str_initial_time,String str_time_step,String str_final_time,
						String str_start_time,String str_ramp_velocity,
		...
		end_time 	= ((final_value - initial_value) + start_time * Double.parseDouble(str_ramp_velocity)) / Double.parseDouble(str_ramp_velocity);
