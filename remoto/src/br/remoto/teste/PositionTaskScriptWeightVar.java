...
public class PositionTaskScriptWeightVar 
{
	...
	public PositionTaskScriptWeightVar()
	{
		// Specify ReMoto's path
		
		
		ReMoto.path = "C:\\Users\\renato\\Dropbox\\PositionTask\\TPWeightVar\\";
	...
	{
		PositionTaskScriptWeightVar teste = new PositionTaskScriptWeightVar();
	...
	public void run() throws FileNotFoundException
	{
		...
		dataPath = ReMoto.path + "data3";
		graphicPath = ReMoto.path + "figures3";
	...
	public void generateAndStoreData(String output, Simulation sim, String dataPath, String graphicPath, String path, int simCount) throws FileNotFoundException{
		...
		int varStep = 10 * simCount;
	
		
		outputFile = new File(dataPath + path + "\\" + output + "_weight" + varStep + ".txt");
	    ...
	    if(output.equals("spikesMNs") || output.equals("spikesIas") || output.equals("firingRateMNs") || output.equals("spikesIaINs") ){
	    	PlotScatter.generate(datasetS,
					 graphicPath + path + "\\" + output + "_weight" + simCount + ".jpg",
					 output, 
					 "Time [ms]", 
					 output);
	    }
