		 ...
		 for (int j = 3; j <= 3; j++){
		  for(int k = 1; k <= 1; k++){
			...
			for(int i = 0; i < conf.getNeuronTypes(ReMoto.DT, ReMoto.TR).size(); i++){	    		
		    	...
		    	if(dt.isActive()){
		    			if(j == 1){
		    				dt.setMean(1000 / (Math.pow(1.02, k-8)/0.0124));
		    				dt.setStd(7);
		    				dt.setOrder(7);
		    				if (k == 1){
		    					dt.setAmp(30.2);
		    				...
		    				dt.setMean(1000 / (Math.pow(1.02, k-8)/0.0102));
		    				dt.setStd(4);
		    				dt.setOrder(4);
		    				if (k == 1){
		    					dt.setAmp(36.4);
		    				...
		    				dt.setMean(1000 / (Math.pow(1.02, k-8)/0.0088));
		    				dt.setStd(2);
		    				dt.setOrder(2);
		    				if (k == 1){
		    					dt.setAmp(40.5);
		    				...
		    				dt.setMean(1000 / (Math.pow(1.02, k-8)/0.0077));
		    				dt.setStd(2);
		    				dt.setOrder(2);
		    				if (k == 1){
		    					dt.setAmp(45.4);
		    				...
		    				dt.setMean(1000 / (Math.pow(1.02, k-8)/0.007));
		    				dt.setStd(2);
		    				dt.setOrder(2);
		    				if (k == 1){
		    					dt.setAmp(51.8);
		    				...
		    				dt.setMean(1000 / (Math.pow(1.02, k-8)/0.0064));
		    				dt.setStd(2);
		    				dt.setOrder(2);
		    				if (k == 1){
		    					dt.setAmp(56.5);
		    				...
		    				dt.setMean(1000 / (Math.pow(1.02, k-8)/0.0059));
		    				dt.setStd(1);
		    				dt.setOrder(1);
		    				if (k == 1){
		    					dt.setAmp(60.1);
		    				...
		    				dt.setMean(1000 / (Math.pow(1.02, k-8)/0.0055 ));
		    				dt.setStd(1);
		    				dt.setOrder(1);
		    				if (k == 1){
		    					dt.setAmp(65.1);
