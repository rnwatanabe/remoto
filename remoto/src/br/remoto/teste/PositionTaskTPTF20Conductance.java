...
public class PositionTaskTPTF20Conductance 
{
	...
	public PositionTaskTPTF20Conductance()
	{
		// Specify ReMoto's path
		
		
		ReMoto.path = "C:\\Users\\renato\\Dropbox\\PositionTask\\TPTF\\";
	...
	{
		PositionTaskTPTF20Conductance teste = new PositionTaskTPTF20Conductance();
	...
	public void run() throws FileNotFoundException
	{
		...
		conf = simDAO.getConfiguration(28);
		...
		ConductanceVO afIaSOLSOLS = conf.getSynapseType("SOL", "SOL", "AF Ia-MN S");
		ConductanceVO afIaSOLMGS = conf.getSynapseType("SOL", "MG", "AF Ia-MN S");
		ConductanceVO afIaSOLLGS = conf.getSynapseType("SOL", "LG", "AF Ia-MN S");
		ConductanceVO afIaMGSOLS = conf.getSynapseType("MG", "SOL", "AF Ia-MN S");
		ConductanceVO afIaMGMGS = conf.getSynapseType("MG", "MG", "AF Ia-MN S");
		ConductanceVO afIaMGLGS = conf.getSynapseType("MG", "LG", "AF Ia-MN S");
		ConductanceVO afIaLGSOLS = conf.getSynapseType("LG", "SOL", "AF Ia-MN S");
		ConductanceVO afIaLGMGS = conf.getSynapseType("LG", "MG", "AF Ia-MN S");
		ConductanceVO afIaLGLGS = conf.getSynapseType("LG", "LG", "AF Ia-MN S");
		
		
		ConductanceVO afIaSOLSOLFF = conf.getSynapseType("SOL", "SOL", "AF Ia-MN FF");
		ConductanceVO afIaSOLMGFF = conf.getSynapseType("SOL", "MG", "AF Ia-MN FF");
		ConductanceVO afIaSOLLGFF = conf.getSynapseType("SOL", "LG", "AF Ia-MN FF");
		ConductanceVO afIaMGSOLFF = conf.getSynapseType("MG", "SOL", "AF Ia-MN FF");
		ConductanceVO afIaMGMGFF = conf.getSynapseType("MG", "MG", "AF Ia-MN FF");
		ConductanceVO afIaMGLGFF = conf.getSynapseType("MG", "LG", "AF Ia-MN FF");
		ConductanceVO afIaLGSOLFF = conf.getSynapseType("LG", "SOL", "AF Ia-MN FF");
		ConductanceVO afIaLGMGFF = conf.getSynapseType("LG", "MG", "AF Ia-MN FF");
		ConductanceVO afIaLGLGFF = conf.getSynapseType("LG", "LG", "AF Ia-MN FF");
		

		ConductanceVO afIaSOLSOLFR = conf.getSynapseType("SOL", "SOL", "AF Ia-MN FR");
		ConductanceVO afIaSOLMGFR = conf.getSynapseType("SOL", "MG", "AF Ia-MN FR");
		ConductanceVO afIaSOLLGFR = conf.getSynapseType("SOL", "LG", "AF Ia-MN FR");
		ConductanceVO afIaMGSOLFR = conf.getSynapseType("MG", "SOL", "AF Ia-MN FR");
		ConductanceVO afIaMGMGFR = conf.getSynapseType("MG", "MG", "AF Ia-MN FR");
		ConductanceVO afIaMGLGFR = conf.getSynapseType("MG", "LG", "AF Ia-MN FR");
		ConductanceVO afIaLGSOLFR = conf.getSynapseType("LG", "SOL", "AF Ia-MN FR");
		ConductanceVO afIaLGMGFR = conf.getSynapseType("LG", "MG", "AF Ia-MN FR");
		ConductanceVO afIaLGLGFR = conf.getSynapseType("LG", "LG", "AF Ia-MN FR");
		
		
		
		conf.setGammaDynamic(40);
		conf.setGammaStatic(40);
		conf.setPrimaryBag1Gain(7500);
		conf.setPrimaryBag2AndChainGain(4000);
		conf.setSecondaryBag2AndChainGain(000);
	...
	for (int j = 0; j <= 0; j++){	
		for(int k = 1; k <= numOfSimulations; k++){
			...
			double nominalConductance = 600;
			
			afIaSOLSOLS.setGmax(nominalConductance -100 * (j));
			afIaSOLMGS.setGmax(nominalConductance - 100 * (j));
			afIaSOLLGS.setGmax(nominalConductance - 100 * (j));
			afIaMGSOLS.setGmax(nominalConductance - 100 * (j));
			afIaMGMGS.setGmax(nominalConductance - 100 * (j));
			afIaMGLGS.setGmax(nominalConductance - 100 * (j));
			afIaLGSOLS.setGmax(nominalConductance - 100 * (j));
			afIaLGMGS.setGmax(nominalConductance - 100 * (j));
			afIaLGLGS.setGmax(nominalConductance - 100 * (j));
			

			afIaSOLSOLFR.setGmax(nominalConductance - 100 * (j));
			afIaSOLMGFR.setGmax(nominalConductance - 100 * (j));
			afIaSOLLGFR.setGmax(nominalConductance - 100 * (j));
			afIaMGSOLFR.setGmax(nominalConductance - 100 * (j));
			afIaMGMGFR.setGmax(nominalConductance - 100 * (j));
			afIaMGLGFR.setGmax(nominalConductance - 100 * (j));
			afIaLGSOLFR.setGmax(nominalConductance - 100 * (j));
			afIaLGMGFR.setGmax(nominalConductance - 100 * (j));
			afIaLGLGFR.setGmax(nominalConductance - 100 * (j));
			

			afIaSOLSOLFF.setGmax(nominalConductance - 100 * (j));
			afIaSOLMGFF.setGmax(nominalConductance - 100 * (j));
			afIaSOLLGFF.setGmax(nominalConductance - 100 * (j));
			afIaMGSOLFF.setGmax(nominalConductance - 100 * (j));
			afIaMGMGFF.setGmax(nominalConductance - 100 * (j));
			afIaMGLGFF.setGmax(nominalConductance - 100 * (j));
			afIaLGSOLFF.setGmax(nominalConductance - 100 * (j));
			afIaLGMGFF.setGmax(nominalConductance - 100 * (j));
			afIaLGLGFF.setGmax(nominalConductance - 100 * (j));

			
			sim.run();
    		
			generateLogOfScenario(k, j, dataPath, path);
			...
			generateAndStoreData("spikesIasSOL", sim, dataPath, graphicPath, path, k, j);
			generateAndStoreData("spikesIasMG", sim, dataPath, graphicPath, path, k, j);
			generateAndStoreData("spikesIasLG", sim, dataPath, graphicPath, path, k, j);
			...
			generateAndStoreData("muscleLengthSOL", sim, dataPath, graphicPath, path, k, j);
			generateAndStoreData("muscleLengthMG", sim, dataPath, graphicPath, path, k, j);
			generateAndStoreData("muscleLengthLG", sim, dataPath, graphicPath, path, k, j);
			generateAndStoreData("jointAngle", sim, dataPath, graphicPath, path, k, j);
			generateAndStoreData("jointTorque", sim, dataPath, graphicPath, path, k, j);
			generateAndStoreData("jointMuscleTorque", sim, dataPath, graphicPath, path, k, j);
	...
	public void generateAndStoreData(String output, Simulation sim, String dataPath, String graphicPath, String path, int simCount, int simCount2) throws FileNotFoundException{
		...
		else if(output.equals("jointMuscleTorque")){
			nmSubplots[0].add(			"jointMuscleTorque");
			nmCdNeurons[0].add(			"");
			nmCdSpecification[0].add(	"");
			yLabels[0].add(				"Torque");
			legendLabels[0].add(		"Ankle");
		...
		else if(output.equals("muscleLengthSOL")){
		...
		else if(output.equals("muscleLengthMG")){
			nmSubplots[0].add(			"muscleLength");
			nmCdNeurons[0].add(			"");
			nmCdSpecification[0].add(	"");
			yLabels[0].add(				"Length [m]");
		...
		else if(output.equals("muscleLengthLG")){
			nmSubplots[0].add(			"muscleLength");
			nmCdNeurons[0].add(			"");
			nmCdSpecification[0].add(	"");
			yLabels[0].add(				"Length [m]");
		...
		int synCond = 600 - 100 * simCount2;
	
		
		outputFile = new File(dataPath + path + "\\" + output + "_TPdef" + simCount  + ".txt");
	    ...
	    if(output.equals("spikesMNs") || output.equals("spikesIas") || output.equals("firingRateMNs") || output.equals("spikesIaINs") ){
	    	PlotScatter.generate(datasetS,
					 graphicPath + path + "\\" + output + "_TPdef"+ simCount + ".jpg",
					 output, 
					 "Time [ms]", 
					 output);
	    }
	    	...
	    	PlotXYLine.generate(datasetS,
	    			 graphicPath + path + "\\" + output + "TPdef" + simCount + ".jpg",
					 output, 
					 "Time [ms]", 
					 output);
	    }
	...
	public void generateLogOfScenario(int simCount, int simCount2, String dataPath, String path) throws FileNotFoundException{
		
		
		File output;
	    

		int synCond = 180 - 100 * simCount2;
	
		
		output = new File(dataPath + path + "\\scenarioTPdef" + simCount + ".txt");
