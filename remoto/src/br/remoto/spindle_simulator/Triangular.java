...
public class Triangular extends Input{

	protected double initial_value;
	protected double final_value;
	//protected Random gaussianNoise = new Random();
	
	public Triangular(String str_initial_time,String str_time_step,String str_final_time,
		...
		end_time = Double.parseDouble(str_end_time_triang);
