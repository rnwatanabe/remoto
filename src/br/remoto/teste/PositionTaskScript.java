...
public class PositionTaskScript 
{
	...
	public PositionTaskScript()
	{
		// Specify ReMoto's path
		
		
		ReMoto.path = "/home/renato/Dropbox/PositionTask/Disturbance/";
	...
	{
		PositionTaskScript teste = new PositionTaskScript();
